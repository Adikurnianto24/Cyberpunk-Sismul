...
class CodeIgniter
{
    ...
    protected function initializeKint()
    {
        ...
        // Update for Kint 4.2
        \Kint\Kint::$depth_limit = $config->maxDepth;
        
        // Set theme for RichRenderer in Kint 4.2
        if (class_exists('\Kint\Renderer\RichRenderer')) {
            \Kint\Renderer\RichRenderer::$folder = $config->richFolder;
        }
        
        // CLI-specific settings if CLI renderer exists
        if (class_exists('\Kint\Renderer\CliRenderer')) {
