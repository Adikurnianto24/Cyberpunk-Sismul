...
<body>
    ...
    <div class="biodata-box">
        ...
        <form action="/mahasiswa/update/<?= $mahasiswa['id']; ?>" method="post">
            ...
            <div class="inputan">
                <input type="text" id="npm" name="npm" value="<?= $mahasiswa['npm']; ?>" required="">
                <label>NPM</label>
            </div>
            <div class="inputan">
            ...
            <div class="inputan">
                <input type="text" id="tgl_lahir" name="tgl_lahir" value="<?= $mahasiswa['tgl_lahir']; ?>" required="">
                <label>Tanggal Lahir</label>
            </div>
            <div class="action">
                <button type="submit" class="action-button">Update Data</button>
            </div>
        </form>
    </div>
